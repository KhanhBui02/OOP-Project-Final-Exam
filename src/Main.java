        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case "5": {
                    ...
                    switch (a) {
                        case "1": {
                            ...
                            System.out.println(
                                    "|id |        Name        | Birthday |  Phone   |       Email        |W.Hour|Salary | Bonus  | Total  |YOE|ProSkill  |");
                            System.out.println(
                                    "+-------------------------------------------------------------------------------------------------------------------+");
                        ...
                        case "2": {
                            System.out.println(
                                    "+---------------------------------------------Display All Fresher----------------------------------------------------------------+");
                            System.out.println(
                                    "|id |        Name        | Birthday |  Phone   |       Email        |W.Hour|Salary | Bonus  | Total  |  GraDate  |GraRank|UniName|");
                            System.out.println(
                                    "+--------------------------------------------------------------------------------------------------------------------------------+");
                        ...
                        case "3": {
                            System.out.println(
                                    "+----------------------------------------------Display All Intern-----------------------------------------------------------+");
                            System.out.println(
                                    "|id |        Name        | Birthday |  Phone   |       Email        |W.Hour|Salary | Bonus  | Total  |  Major   |Sem|UniName|");
                            System.out.println(
                                    "+---------------------------------------------------------------------------------------------------------------------------+");
                        ...
                        case "4": {
                            ...
                            System.out.println(
                                    "|id |        Name        | Birthday |  Phone   |       Email        |W.Hour|Salary | Bonus  | Total  |");
                ...
                case "6": {
                    ...
                    System.out.println("|Enter 1: Report By Total Salary Increase |");
                    System.out.println("|Enter 2: Report By Total Salary Decrease |");
